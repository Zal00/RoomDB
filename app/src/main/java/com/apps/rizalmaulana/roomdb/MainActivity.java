...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.interfaceDAO().tambahAktivis(aktivisEntity);

        //TAMPIL SELURUH DATA
        Log.d("TAMPIL","Tampil seluruh data aktivis");
        Log.d("TAMPIL","===========================");

        aktivisEntities = db.interfaceDAO().tampilSeluruhAktivis();
        ...
        Log.e("ZONE","===================");
        aktivisEntityListByZone = db.interfaceDAO().findByZone("Jakarta");
